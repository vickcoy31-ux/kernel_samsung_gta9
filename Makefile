...
KBUILD_CFLAGS   := -Wall -Wundef -Wno-error=strict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-error=implicit-function-declaration -Wno-error=implicit-int -Wno-error=implicit-int \
		   -Wno-error=return-type -Wno-format-security \
		   -std=gnu89 -Wno-error -Wno-error -Wno-deprecated-non-prototype -Wno-unused-function -Wno-unused-label -Wno-error=implicit-function-declaration -Wno-error=single-bit-bitfield-constant-conversion -Wno-error=unused-result -Wno-error
